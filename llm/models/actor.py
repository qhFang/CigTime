...
from transformers import AutoModelForCausalLM, BitsAndBytesConfig, PreTrainedModel, AutoModel
...
import sys
sys.path.append('.')
from llm.models.utils import find_all_linear_names, log_probs_from_logits
...
class Actor(nn.Module):
    ...
    def __init__(
        ...
        if isinstance(pretrain_or_model, str):
            ...
            #state_dict = torch.load("/media/xuzhao/Partition5/qyzheng/qihang/llama3/model.pth", map_location="cpu")
    ...
    def generate(self, input_ids: torch.Tensor, **kwargs) -> Union[
        ...
        print(sequences)
        print(generate_args["eos_token_id"])
        exit()
        # Prepare mask tensor
