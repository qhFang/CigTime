...
def parse_and_load_from_model(parser):
    ...
    assert os.path.exists(args_path), 'Arguments json file was not found!' + args_path
...
def add_edit_options(parser):
    ...
    group.add_argument("--edit_file", required=True, type=str,
                          help="Path to a text file lists motions to be edited.")
...
def add_evaluation_options(parser):
    ...
    group.add_argument("--guidance_param", default=2.5, type=float,
                       help="For classifier-free sampling - specifies the s parameter, as defined in the paper.")
    group.add_argument("--gt_file", required=True, type=str,help="Path to ground truth file.")
    group.add_argument("--result_file", required=True, type=str, help="Path to result file.")
