    ...
    for motion_loader_name, motion_loader in motion_loaders.items():
        ...
        with torch.no_grad():
            for idx, batch in enumerate(motion_loader):
                word_embeddings, pos_one_hots, caption, sent_lens, motions, m_lens, tokens = batch
    ...
    with open(log_file, 'w') as f:
        ...
        for replication in range(replication_times):
            ...
            for motion_loader_name, motion_loader_getter in eval_motion_loaders.items():
                ...
                motion_loaders[motion_loader_name] = motion_loader_getter
...
if __name__ == '__main__':
    ...
    split = 'test'
    gt_loader = get_dataset_loader(name=args.dataset, batch_size=args.batch_size, num_frames=None, split=split, hml_mode='gt', gt_file=args.gt_file, text_file=args.text_file)
    gen_loader = get_dataset_loader(name=args.dataset, batch_size=args.batch_size, num_frames=None, split=split, hml_mode='evalgt', result_file=args.result_file, text_file=args.text_file)
    ...
    eval_motion_loaders = {
        ### We directly load the edited motions for evaluation
        'vald': gen_loader
    }
